...
JNIEXPORT jlong JNICALL Java_com_example_simplemnnchat_ChatSession_initNative(JNIEnv* env, jobject thiz, jstring modelDir,
...
JNIEXPORT jobject JNICALL Java_com_example_simplemnnchat_ChatSession_submitNative(JNIEnv* env, jobject thiz,
...
JNIEXPORT void JNICALL Java_com_example_simplemnnchat_ChatSession_resetNative(JNIEnv* env, jobject thiz, jlong llmPtr) {
    history.resize(1);
    Llm* llm = reinterpret_cast<Llm*>(llmPtr);
    if (llm) {
        llm->reset();
...
JNIEXPORT void JNICALL Java_com_example_simplemnnchat_ChatSession_releaseNative(JNIEnv* env,
                                                                                      jobject thiz,
                                                                                      jlong objecPtr,
                                                                                      jboolean isDiffusion) {
    MNN_DEBUG("Java_com_example_simplemnnchat_ChatSession_releaseNative\n");
    if (isDiffusion) {
...
Java_com_example_simplemnnchat_submitDiffusionNative(JNIEnv *env, jobject thiz,
                                                                       jlong instance_id,
                                                                       jstring input,
